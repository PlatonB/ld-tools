...
Возможно, единственный подходящий источник данных для расчёта LD - таблицы популяционно-генетического проекта _1000 Genomes_. Вот крохотный отрывок одного из этих гигантских файлов:
